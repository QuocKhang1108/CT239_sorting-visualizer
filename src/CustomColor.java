...
public class CustomColor {
    public static Color mainBackground = new Color(1, 4, 9);
    public static Color canvasBackground = new Color(13, 17, 23);
    public static Color btnEntered = new Color(31, 110, 234, 255);
    public static Color btnPressed = new Color(35, 133, 54, 255);
